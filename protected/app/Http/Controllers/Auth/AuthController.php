...
class AuthController extends Controller
{
    ...
    */
    ...
    protected $username = 'username'; //untuk login dengan username
    ...
    protected $redirectAfterLogout = 'auth/login'; //path after logout
    ...
    protected function validator(array $data)
    {
        return Validator::make($data, [
            ...
            'email' => 'required|email|max:255|unique:optimcj_users',
